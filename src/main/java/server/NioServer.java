...
//            clientWorker = new NioEventLoopGroup(clientWorkingThreads);
            acceptor = new NioEventLoopGroup(IniFile.getClientAcceptingThreads());
            worker = new NioEventLoopGroup(IniFile.getClientWorkingThreads());
...
//                    ch.pipeline().addLast("packetEncoder", new PacketEncoder());
            ...
            clientChannel = bootstrap.bind(connectionIP, connectionPort).sync();
...
//            serverBoot.group(serverAcceptor, serverWorker).channel(NioServerSocketChannel.class).childHandler(new ChannelInitializer()
            acceptor = new NioEventLoopGroup(IniFile.getServerAcceptingThreads());
            worker = new NioEventLoopGroup(IniFile.getServerWorkingThreads());
            ...
            serverChannel = bootstrap.bind(serverIP, serverPort).sync();
