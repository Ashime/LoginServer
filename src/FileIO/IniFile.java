...
public class IniFile
{
    ...
    private static boolean noLoginAuth;             // Determines whether the logins will be authenticated.
    ...
    private static void loginServerInfo()
    {
        try 
        {
            ...
            // [SECURITY]
            noLoginAuth = ini.get("SECURITY", "NO_LOGIN_AUTH", boolean.class);
    ...
    public static boolean isNoLoginAuth() {
        return noLoginAuth;
    }
